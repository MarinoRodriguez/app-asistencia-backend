    ...
    <AdminLayout>
      <header className="bg-white border-b border-slate-200 px-8 py-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Administración de Personas</h2>
            <p className="text-slate-500 text-sm">Gestiona la información de todos los miembros y colaboradores.</p>
          </div>
          <button
